...
-- Kastros ERP — Supabase bootstrap (schema + RLS + storage bucket + seed)
...
ALTER TABLE public."UnitDef" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Counterparty" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Location" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Trade" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."TradeActivity" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."MarketPrice" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."DeskMarketPrice" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Position" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."PositionLeg" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."MTMValue" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."PositionAdjustment" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."ExecutionContract" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."ContractWarehouseAllocation" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."PendingTruck" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."GatepassDocument" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."InboundReceipt" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."OutboundDispatch" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."SpotPurchaseEvent" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."PaymentRequest" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."ChangeRequest" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Invoice" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Payment" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."CashFlowEntry" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."Reconciliation" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."BankTransaction" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."TraceabilityRecord" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."TraceChainEntry" ENABLE ROW LEVEL SECURITY;
...
VALUES ('gatepass-docs', 'gatepass-docs', false, 10485760, ARRAY['application/pdf','image/jpeg','image/png','image/webp'])
...
('usr_execution','execution@kastros.com','$2b$12$kPHAHRpawDy8YV3CNfy6FexSjsITEdECpCwqpROTmrRFhddpa0oxW','Asad Hussain','EXECUTION',false,now()),
('usr_executionhead','executionhead@kastros.com','$2b$12$kPHAHRpawDy8YV3CNfy6FexSjsITEdECpCwqpROTmrRFhddpa0oxW','Execution Head','EXECUTION',true,now()),
('usr_finance','finance@kastros.com','$2b$12$kPHAHRpawDy8YV3CNfy6FexSjsITEdECpCwqpROTmrRFhddpa0oxW','Sana Rizvi','FINANCE',false,now()),
('usr_financehead','financehead@kastros.com','$2b$12$kPHAHRpawDy8YV3CNfy6FexSjsITEdECpCwqpROTmrRFhddpa0oxW','Finance Head','FINANCE',true,now()),
('usr_risk','risk@kastros.com','$2b$12$kPHAHRpawDy8YV3CNfy6FexSjsITEdECpCwqpROTmrRFhddpa0oxW','Omar Khan','RISK_MANAGER',false,now()),
('usr_viewer','viewer@kastros.com','$2b$12$kPHAHRpawDy8YV3CNfy6FexSjsITEdECpCwqpROTmrRFhddpa0oxW','Read Only User','READ_ONLY',false,now())
...
('BAG_50','BAG (50 kg)',50),('BAG_100','BAG (100 kg)',100)
