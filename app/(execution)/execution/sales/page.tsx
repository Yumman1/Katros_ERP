    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-2 text-xs font-medium text-zinc-500">
          ...
          <span>/</span>
          <span className="text-zinc-400">Sales — Ex Warehouse</span>
        </div>
        <div className="mt-2 flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold text-white">Gate Out — Allocate to Sales</h1>
            <p className="mt-1 text-sm text-zinc-500">
              Trucks leaving the warehouse · assign tonnes to open sale orders · inventory updates on each
              allocation
            </p>
          </div>
          <Link
      ...
      <div className="grid grid-cols-3 gap-3">
        <StatChip
          ...
          color="#f59e0b"
        />
        <StatChip label="Open sale orders" value={openContracts.length} color="#f59e0b" />
        <StatChip
          label="Open volume"
