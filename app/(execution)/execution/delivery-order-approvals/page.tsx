...
export default function DoExecutionApprovalsPage() {
  ...
  return (
    <div className="kastros-desk-page">
      <PageHeader
        ...
        subtitle="Approve delivery orders before finance release. Gate passes are issued only after both approvals."
      />
