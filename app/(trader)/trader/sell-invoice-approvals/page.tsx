  ...
  return (
    <div className="kastros-desk-page">
      <PageHeader
        ...
        subtitle="Paid sale trucks clear automatically — only release-on-credit requests need your approval. Released-but-unpaid trucks stay below as payment reminders."
      />
